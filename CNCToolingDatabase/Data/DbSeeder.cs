...
public static class DbSeeder
{
    public static void Seed(ApplicationDbContext context)
    {
        ...
        {
            var users = new[] { ("Adib Jamil", "adib.jamil", "123"), ("Bakhari Hussin", "bakhari.hussin", "123"),
                ("Faiq Faizul", "faiq.faizul", "123"), ("Hakim Hisham", "hakim.hisham", "123"),
                ("Hakim Ramaly", "hakim.ramaly", "123"), ("Ismail Jahrin", "ismail.jahrin", "123"),
                ("Low Boon Bao", "boon.bao", "123"), ("Nik Faiszal Abdullah", "nik.faiszal", "123"),
                ("Tan Chee Wei", "chee.wei", "123") };
            foreach (var (displayName, username, password) in users)
            {
        ...
        try
        {
            ...
            {
                var projectCodes = "AG01|AG02|AG03|AG04|AG07|AG08|AG09|AH02|AH03|AH05|AL01|AL02|AL04|AL06|AL07|AL08|AL09|AL10|AL11|AM01|AM03|AM04|AOG|AP02|AQ01|SA01|SB01".Split('|');
